...
var buildRegistration = (0, _babelTemplate2.default)('__RAX_HOT_LOADER__.register(ID, NAME, FILENAME);');
        ...
        classBody.get('body').forEach(function (path) {
          if (path.isClassProperty()) {
            ...
            if (node.value && node.value.type === 'ArrowFunctionExpression') {
              ...
              var newIdentifier = t.identifier('__' + node.key.name + '__RAX_HOT_LOADER__');
