...
var ModuleDependency = function (_Dependency) {
  _inherits(ModuleDependency, _Dependency);

  function ModuleDependency(request) {
    _classCallCheck(this, ModuleDependency);

    var _this = _possibleConstructorReturn(this, (ModuleDependency.__proto__ || Object.getPrototypeOf(ModuleDependency)).call(this));
  ...
  _createClass(ModuleDependency, [{
    key: 'isEqualResource',
    value: function isEqualResource(other) {
