...
var ModuleHotAcceptDependency = function (_ModuleDependency) {
  _inherits(ModuleHotAcceptDependency, _ModuleDependency);

  function ModuleHotAcceptDependency(request, range) {
    _classCallCheck(this, ModuleHotAcceptDependency);

    var _this = _possibleConstructorReturn(this, (ModuleHotAcceptDependency.__proto__ || Object.getPrototypeOf(ModuleHotAcceptDependency)).call(this, request));
