...
module.exports = function (webpackConfig) {
  var UPDATE_FILE_NAME = 'webpack.config.update.js';
  var webpackConfigUpdatePath = path.join(process.cwd(), UPDATE_FILE_NAME);
  ...
  if (pathExists.sync(webpackConfigUpdatePath)) {
    ...
    console.log('');
    var webpackConfigUpdateRef = void 0;
    try {
    ...
    if (typeof webpackConfigUpdateRef !== 'function') {
      ...
      console.info('see', colors.underline.white('https://github.com/alibaba/rax/blob/master/packages/rax-scripts/README.md#update-webpack-config'));
      process.exit(1);
    } else {
      var webpackConfigUpdated = webpackConfigUpdateRef(webpackConfig);
